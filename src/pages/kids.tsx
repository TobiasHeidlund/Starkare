...
function kids({setPopup}:Prop) {
  return (
    ...
    <button onClick={()=>{setPopup("Boka Kidsträninig")}}>Kontakta oss</button>    
    </div> 
    ...
    <div className='localcardbox'>
      ...
      <CardBox title={"Grupp 1: "} text={"7-12 år: \nTisdagar 16.00-16:45 \n Pris: 2300/termin"}boxname={"cardbox4"}/>
      <CardBox title={"Grupp 2: "} text={"9-12 år: \nTorsdagar 16.00-16:45 \n Pris: 2300/termin"}boxname={"cardbox4"}/>
      ...
      <h3>Terminen startar v.36 och håller på till v.50 med uppehåll för höstlov och röda dagar.</h3>
    </div>
