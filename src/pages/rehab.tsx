...
function rehab({setPopup}:Prop) {
  return (
    ...
    <CardBox title={"Nybesök"} text={"Vid ett nybesök får du förklara din smärtproblematik för din terapeut. Efter konsultationen utförs ortopediska tester och en behandlingsplan tas fram. \nPris:650kr"} boxname={"cardbox2"}/>
    <CardBox title={"Återbesök"} text={"Under återbesöken får du ett individanpassat rehab-upplägg för att du ska kunna bli smärtfri. Övningarna gås igenom tillsammans med din terapeut i vårt gym. \nPris:500kr"}boxname={"cardbox2"}/>
