...
function mamma({setPopup}:Prop) {
  ...
  return (
    ...
    <section className='cardContaienr2'>
      ...
      <CardBox title={""} text={"Barn är givetvis välkomna att följa med under passet. Ta gärna med dig babysitter, bilskydd, lekmatta, bärsele eller något annat som du vet att ditt barn trivs i. \n I anmälningen ingår det även 2 pass/vecka på ordinarie schema. Bokas på egen hand i vår bokningsapp."} boxname={"cardbox3"}/>
